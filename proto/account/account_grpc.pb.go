...
type AccountServiceClient interface {
	...
	Get(ctx context.Context, in *SingleAccountRequest, opts ...grpc.CallOption) (*AccountResponse, error)
...
func (c *accountServiceClient) Get(ctx context.Context, in *SingleAccountRequest, opts ...grpc.CallOption) (*AccountResponse, error) {
	out := new(AccountResponse)
...
type AccountServiceServer interface {
	...
	Get(context.Context, *SingleAccountRequest) (*AccountResponse, error)
...
func (UnimplementedAccountServiceServer) Get(context.Context, *SingleAccountRequest) (*AccountResponse, error) {
