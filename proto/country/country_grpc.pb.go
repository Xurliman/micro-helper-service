...
func (c *countryServiceClient) List(ctx context.Context, in *ListCountryRequest, opts ...grpc.CallOption) (*ListCountryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/CountryService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *countryServiceClient) Get(ctx context.Context, in *SingleCountryRequest, opts ...grpc.CallOption) (*CountryProfileResponse, error) {
	out := new(CountryProfileResponse)
	err := c.cc.Invoke(ctx, "/CountryService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CountryService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CountryService/List",
	}
