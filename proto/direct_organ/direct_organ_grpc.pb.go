...
const (
	DirectOrganService_List_FullMethodName   = "/DirectOrganService/List"
	DirectOrganService_Create_FullMethodName = "/DirectOrganService/Create"
	DirectOrganService_Get_FullMethodName    = "/DirectOrganService/Get"
	DirectOrganService_Update_FullMethodName = "/DirectOrganService/Update"
	DirectOrganService_Delete_FullMethodName = "/DirectOrganService/Delete"
)
...
func (c *directOrganServiceClient) List(ctx context.Context, in *ListDirectOrganRequest, opts ...grpc.CallOption) (*ListDirectOrganResponse, error) {
	out := new(ListDirectOrganResponse)
	err := c.cc.Invoke(ctx, DirectOrganService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *directOrganServiceClient) Create(ctx context.Context, in *CreateDirectOrganRequest, opts ...grpc.CallOption) (*DirectOrganProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, DirectOrganService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *directOrganServiceClient) Get(ctx context.Context, in *SingleDirectOrganRequest, opts ...grpc.CallOption) (*DirectOrganProfileResponse, error) {
	out := new(DirectOrganProfileResponse)
	err := c.cc.Invoke(ctx, DirectOrganService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDirectOrganServiceServer) List(context.Context, *ListDirectOrganRequest) (*ListDirectOrganResponse, error) {
...
func _DirectOrganService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDirectOrganRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DirectOrganServiceServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DirectOrganService_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DirectOrganServiceServer).List(ctx, req.(*ListDirectOrganRequest))
	}
...
func _DirectOrganService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DirectOrganService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DirectOrganService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SingleDirectOrganRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DirectOrganServiceServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DirectOrganService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DirectOrganServiceServer).Get(ctx, req.(*SingleDirectOrganRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DirectOrganService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DirectOrganService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DirectOrganService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DirectOrganService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DirectOrganService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "List",
			Handler:    _DirectOrganService_List_Handler,
		},
		{
			MethodName: "Create",
		...
		{
			MethodName: "Get",
			Handler:    _DirectOrganService_Get_Handler,
		},
		{
			MethodName: "Update",
