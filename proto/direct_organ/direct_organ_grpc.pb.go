...
func (c *directOrganServiceClient) List(ctx context.Context, in *ListDirectOrganRequest, opts ...grpc.CallOption) (*ListDirectOrganResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/DirectOrganService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *directOrganServiceClient) Get(ctx context.Context, in *SingleDirectOrganRequest, opts ...grpc.CallOption) (*DirectOrganProfileResponse, error) {
	out := new(DirectOrganProfileResponse)
	err := c.cc.Invoke(ctx, "/DirectOrganService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DirectOrganService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/DirectOrganService/List",
	}
...
func _DirectOrganService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/DirectOrganService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
